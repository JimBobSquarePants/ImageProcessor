...
namespace ImageProcessor.Metadata
{
    ...
    public static class ExifPropertyTagConstants
    {
        ...
        /// </summary>
        public static readonly ExifPropertyTag[] GeolocationPropertyItems = RequiredPropertyItems.Union(
        new[]
        {
        ...
        /// </summary>
        public static readonly ExifPropertyTag[] CopyrightPropertyItems = RequiredPropertyItems.Union(
        new[]
        {
        ...
        /// </summary>
        public static readonly ExifPropertyTag[] CopyrightAndGeolocationPropertyItems =
            GeolocationPropertyItems.Union(CopyrightPropertyItems).ToArray();
