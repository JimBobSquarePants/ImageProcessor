...
namespace ImageProcessor.Metadata
{
    ...
    internal readonly struct Int32Converter
    {
        ...
        /// <summary>
        /// Allows the implicit conversion of an instance of <see cref="Int32Converter"/> to a <see cref="int"/>.
        /// </summary>
        /// <param name="value">
        ...
        /// <summary>
        /// Allows the implicit conversion of an instance of <see cref="int"/> to a <see cref="Int32Converter"/>.
        /// </summary>
        /// <param name="value">The instance of <see cref="int"/> to convert.</param>
        /// <returns>An instance of <see cref="Int32Converter"/>.</returns>
