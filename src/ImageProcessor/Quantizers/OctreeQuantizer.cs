...
namespace ImageProcessor.Quantizers
{
    ...
    public unsafe class OctreeQuantizer : Quantizer
    {
        ...
        private class Octree
        {
            ...
            /// </summary>
            /// <param name="pixel">The <see cref="Bgra32"/>containing color information to add.</param>
            ...
            /// </summary>
            /// <param name="pixel">The <see cref="Bgra32"/> containing the pixel data.</param>
            /// <returns>
            /// The index of the given structure.
            /// </returns>
            public int GetPaletteIndex(Bgra32* pixel) => this.root.GetPaletteIndex(pixel, 0);
            ...
            protected class OctreeNode
            {
                ...
                /// </summary>
                /// <param name="pixel">The <see cref="Bgra32"/> representing the pixel.</param>
