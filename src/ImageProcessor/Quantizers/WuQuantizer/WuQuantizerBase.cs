...
namespace ImageProcessor.Quantizers
{
    ...
    public abstract class WuQuantizerBase : IWuQuantizer
    {
        ...
        public Bitmap Quantize(Image image, int alphaThreshold, int alphaFader)
            => this.Quantize(image, alphaThreshold, alphaFader, null, 256);
        ...
        /// A quantized version of the image.
        /// </returns>
        private Bitmap Quantize(Image source, int alphaThreshold, int alphaFader, Histogram histogram, int maxColors)
        {
            // First off take a 32bpp copy of the image
            Bitmap copy = FormatUtilities.DeepCloneImageFrame(source, PixelFormat.Format32bppArgb);

            try
            {
                var buffer = new ImageBuffer(copy);
                ...
                Bgra32[] lookups = BuildLookups(cubes, histogram.Moments);
        ...
        /// </param>
        /// <param name="lookups">
        /// The array of <see cref="Bgra32"/> containing indexed versions of the images colors.
        /// </param>
        /// <param name="alphaThreshold">
        /// All colors with an alpha value less than this will be considered fully transparent.
        /// </param>
        ...
        /// </returns>
        internal abstract Bitmap GetQuantizedImage(ImageBuffer imageBuffer, int colorCount, Bgra32[] lookups, int alphaThreshold);
        ...
        private static void BuildHistogram(Histogram histogram, ImageBuffer imageBuffer, int alphaThreshold, int alphaFader)
        {
            ...
            foreach (Bgra32[] pixelLine in imageBuffer.PixelLines)
            {
                foreach (Bgra32 pixel in pixelLine)
                {
            ...
            moments[0, 0, 0, 0].Add(new Bgra32(0, 0, 0, 0));
        }
        ...
        /// </summary>
        /// <param name="moments">The <see cref="ColorMoment"/>.</param>
        /// <param name="cube">The <see cref="Box"/> cube.</param>
        /// <param name="direction">The direction.</param>
        /// <param name="first">The first byte.</param>
        /// <param name="last">The last byte.</param>
        /// <param name="whole">The whole <see cref="ColorMoment"/>.</param>
        /// <returns>
        ...
        /// </summary>
        /// <param name="moments">The three dimensional array of <see cref="ColorMoment"/>.</param>
        /// <param name="first">The first <see cref="Box"/>.</param>
        /// <param name="second">The second <see cref="Box"/>.</param>
        /// <returns>
        ...
        /// </summary>
        /// <param name="cubes">The array of <see cref="Box"/> cubes.</param>
        /// <param name="moments">The three dimensional array of <see cref="ColorMoment"/>.</param>
        /// <returns>
        /// The array of <see cref="Bgra32"/>.
        /// </returns>
        private static Bgra32[] BuildLookups(Box[] cubes, ColorMoment[,,,] moments)
        {
            var lookups = new Bgra32[cubes.Length];
