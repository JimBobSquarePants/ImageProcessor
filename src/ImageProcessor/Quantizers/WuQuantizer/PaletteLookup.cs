...
namespace ImageProcessor.Quantizers
{
    ...
    internal class PaletteLookup
    {
        ...
        /// The palette.
        /// </param>
        public PaletteLookup(Bgra32[] palette)
        {
        ...
        /// </returns>
        public byte GetPaletteIndex(Bgra32 pixel)
        {
            ...
            {
                Bgra32 lookupPixel = lookup.Color32;
        ...
        /// </returns>
        private static int GetMask(Bgra32[] palette)
        {
            ...
            var maskedPixel = new Bgra32(alphaMask, redMask, greenMask, blueMask);
        ...
        /// The palette.
        /// </param>
        private void BuildLookup(Bgra32[] palette)
        {
