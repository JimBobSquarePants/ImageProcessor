    ...
    public abstract unsafe class Quantizer : IQuantizer
    {
        ...
        protected virtual void FirstPass(BitmapData sourceData, int width, int height)
        {
            ...
            for (int row = 0; row < height; row++)
            {
                ...
                for (int col = 0; col < width; col++, sourcePixel++)
                {
                    ...
                    this.InitialQuantizePixel((Bgra32*)sourcePixel);
                }
        ...
        protected virtual void SecondPass(BitmapData sourceData, Bitmap output, int width, int height, Rectangle bounds)
        {
            ...
            try
            {
                ...
                byte pixelValue = this.QuantizePixel((Bgra32*)sourcePixel);
                ...
                *destinationPixel = pixelValue;
                ...
                for (int row = 0; row < height; row++)
                {
                    ...
                    for (int col = 0; col < width; col++, sourcePixel++, destinationPixel++)
                    {
                        ...
                        {
                            // Quantize the pixel
                            pixelValue = this.QuantizePixel((Bgra32*)sourcePixel);
