// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensionsUnitTests.cs" company="James Jackson-South">
...
namespace ImageProcessor.Web.UnitTests.Extensions
{
    ...
    public class StringExtensionsUnitTests
    {
        ...
        /// ':' is failing for some reason in VS but not elsewhere. Could be a configuration issue.
        /// </remarks>
        [Test]
